...
import { logSettingsAction, logError } from "../../utils/activityLogger";
...
const PlatformSettings: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<"general" | "seo" | "security">(
    "general",
  );
  ...
  const [seoSettings, setSeoSettings] = useState<SEOSettings>({
    ...
    metaDescription:
      "Watch latest Chhattisgarhi movies, web series, and short films online.",
  ...
  const handleSaveGeneral = async () => {
    ...
    try {
      ...
      // ✅ ADD LOGGING
      await logSettingsAction("update", "general", {
      ...
      // ✅ ADD ERROR LOGGING
      await logError("Platform Settings", "Failed to save general settings", {
        error,
      });
    } finally {
      setSaving(false);
  ...
  const handleSaveSEO = async () => {
    ...
    try {
      ...
      // ✅ ADD LOGGING
      await logSettingsAction("update", "seo", {
      ...
      // ✅ ADD ERROR LOGGING
      await logError("Platform Settings", "Failed to save SEO settings", {
        error,
      });
    } finally {
      setSaving(false);
  ...
  const handleSaveSecurity = async () => {
    ...
    try {
      ...
      // ✅ ADD LOGGING
      await logSettingsAction("update", "security", {
      ...
      // ✅ ADD ERROR LOGGING
      await logError("Platform Settings", "Failed to save security settings", {
        error,
      });
    } finally {
      setSaving(false);
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
                  ...
                  <button
                    ...
                    className={`relative w-14 h-8 rounded-full transition-all ${
                      generalSettings.enableRegistration
                        ? "bg-green-500"
                ...
                <div className="flex items-center justify-between p-4 bg-orange-50 dark:bg-orange-900/20 rounded-xl border border-orange-200 dark:border-orange-800">
                  ...
                  >
                    <div
                      className={`absolute top-1 w-6 h-6 bg-white rounded-full transition-all ${
                        generalSettings.maintenanceMode ? "right-1" : "left-1"
                      }`}
                    />
                  </button>
                </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
                ...
                >
                  <div
                    className={`absolute top-1 w-6 h-6 bg-white rounded-full transition-all ${
                      securitySettings.enableTwoFactor ? "right-1" : "left-1"
                    }`}
                  />
                </button>
              </div>
