                ...
                >
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
                            ...
                            <p className="text-slate-800 dark:text-white">{comment.comment}</p>
                            {comment.rating && (
...
const CommentsModeration: React.FC = () => {
    ...
    const handleApprove = async (id: string) => {
        ...
        try {
            ...
            setComments((prev) =>
                prev.map((c) =>
                    c.id === id ? { ...c, status: 'approved', reports: 0, reportReasons: [] } : c
                )
            );
            ...
            <div className="space-y-6 w-full">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-white/90 text-lg">Review and moderate reported comments</p>
                            </div>
                        </div>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-800 overflow-hidden">
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-20">
                            <MessageSquare className="text-slate-300 dark:text-slate-600" size={64} />
                                ...
                                <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                                    {filteredComments.map((comment) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <span
                                                    className={`px-3 py-1 rounded-full text-xs font-bold ${comment.reports > 5
                                            ...
                                            <td className="px-6 py-4">
                                                <span
                                                    className={`px-3 py-1 rounded-full text-xs font-bold capitalize ${comment.status === 'approved'
