...
import { logReportAction, logError } from "../../utils/activityLogger";
        ...
        >
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="p-4 bg-slate-50 dark:bg-slate-800 rounded-xl">
              ...
              <p className="text-slate-800 dark:text-white font-bold mb-2">
                {report.reason}
              </p>
              {report.description && (
...
const ReportsManagement: React.FC = () => {
  ...
  const handleResolve = async (id: string, resolution: string) => {
    ...
    // Find report details before resolving
    ...
    try {
      ...
      await logReportAction(
        "resolve",
        id,
        report?.reportedContentTitle || "Unknown Content",
        {
      ...
      // ✅ ADD ERROR LOGGING
      await logError("Reports Management", "Failed to resolve report", {
        error,
        reportId: id,
        contentTitle: report?.reportedContentTitle,
      });
    }
  };
  ...
  const handleDismiss = async (id: string) => {
    ...
    // Find report details before dismissing
    const report = reports.find((r) => r.id === id);
    ...
    try {
      ...
      // ✅ ADD ERROR LOGGING
      await logError("Reports Management", "Failed to dismiss report", {
        error,
        reportId: id,
        contentTitle: report?.reportedContentTitle,
      });
  ...
  const handleDelete = async (id: string) => {
    ...
    // Find report details before deleting
    const report = reports.find((r) => r.id === id);
