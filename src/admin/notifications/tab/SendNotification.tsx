...
import { sendNotification, getTemplates } from '../../../services/notificationService';
import { ref, uploadBytes, getDownloadURL } from 'firebase/storage';
import type { NotificationTemplate, NotificationType, NotificationPriority, NotificationTarget } from '../../../types/notification';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const notificationData: any = {
                ...
                contentType: formData.contentType || undefined, // ✅ FIXED: Only send if not empty
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        >
                            ...
                            <div>
                                <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">
                                    Title * <span className="text-xs text-slate-500">(Max 50 characters)</span>
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">
                                    Message * <span className="text-xs text-slate-500">(Max 200 characters)</span>
                                </label>
                                <textarea
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="flex gap-2 mb-3">
                                    <button
                                        ...
                                        className={`flex-1 px-4 py-2 rounded-xl font-semibold transition-all ${imageUploadMode === 'url'
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 px-4 py-2 rounded-xl font-semibold transition-all ${imageUploadMode === 'upload'
                                            ? 'bg-blue-500 text-white'
                                            : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400'
                                            }`}
                                    >
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-3">
                                    <button
                                        ...
                                        className={`w-12 h-6 rounded-full transition-all ${scheduleEnabled ? 'bg-blue-500' : 'bg-slate-300 dark:bg-slate-700'
                                            } relative`}
                                    >
                                        <div
                                            className={`w-5 h-5 bg-white rounded-full absolute top-0.5 transition-all ${scheduleEnabled ? 'left-6' : 'left-0.5'
                                                }`}
                                        />
                                    </button>
                            ...
                            <div className="flex items-center gap-3">
                                <button
                                    type="button"
                                    onClick={() => setFormData({ ...formData, isSilent: !formData.isSilent })}
                                    className={`w-12 h-6 rounded-full transition-all ${formData.isSilent ? 'bg-purple-500' : 'bg-slate-300 dark:bg-slate-700'
                                        } relative`}
                                >
                                    <div
                                        className={`w-5 h-5 bg-white rounded-full absolute top-0.5 transition-all ${formData.isSilent ? 'left-6' : 'left-0.5'
                                            }`}
                                    />
                                </button>
                                ...
                                <div className="bg-white dark:bg-slate-900 rounded-xl shadow-lg p-4 space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">
                                            {previewData.message || 'Notification message will appear here...'}
                                        </p>
                                    </div>
