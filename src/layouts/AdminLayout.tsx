...
const AdminLayout: React.FC = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      badge:
        counts.pendingApprovals > 0 ? counts.pendingApprovals.toString() : null,
    ...
    // Moderation
    {
      ...
      badge:
        counts.pendingComments > 0 ? counts.pendingComments.toString() : null,
    ...
    },
    {
      ...
      badge:
        counts.pendingReports > 0 ? counts.pendingReports.toString() : null,
    ...
    },
    {
      ...
      badge:
        counts.pendingTransactions > 0
          ? counts.pendingTransactions.toString()
          : null,
    ...
    },
    {
      ...
      badge:
        counts.pendingPayouts > 0 ? counts.pendingPayouts.toString() : null,
  ...
  return (
    <div
      className={`min-h-screen ${bgClass} flex font-Poppins transition-colors duration-300`}
    >
      {/* Animated Background */}
      ...
      >
        {/* Logo */}
        <div
          className={`h-20 flex items-center px-6 border-b ${darkMode ? "border-slate-800/50" : "border-slate-200/50"}`}
        >
          <motion.div
          ...
          {menuItems.map((item) => {
            ...
            return (
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-2xl transition-all relative group overflow-hidden ${
                  isActive
              ...
              >
                ...
                {sidebarCollapsed && (
                  <motion.div
                    ...
                    } text-sm rounded-xl whitespace-nowrap shadow-xl pointer-events-none border ${
      ...
      >
        ...
        <header className="h-24 flex items-center justify-between px-8 mb-8 relative">
          <div>
            <h2
              className={`text-3xl font-black ${textPrimary} flex items-center gap-3`}
            >
